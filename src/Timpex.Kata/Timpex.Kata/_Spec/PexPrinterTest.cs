...
namespace Timpex.Kata._Spec
{
    ...
    public class PexPrinterTest
    {
        ...
        [Test]
        public void It_Should_Return_Pex_When_counter_is_1()
        {
            ...
            _sut = new PexPrinter(_numberCounter, _counterPredicat);
            String _result = _sut.Print();
            _numberCounter.AssertWasCalled(x => x.IncrementNumber());
            Assert.AreEqual(_result, "pex");
        }

        [Test]
        public void It_Should_Return_Pex_Counter()
        {
            _numberCounter.Stub(x => x.IncrementNumber());
            ...
            String _result = _sut.Print();
            _numberCounter.AssertWasCalled(x => x.IncrementNumber());
            Assert.AreEqual(_result, "pex2");
        }

        [Test]
        public void It_Should_Return_Pex_Tim_When_Counter_Is_Dividable_With_Three()
        {
            _numberCounter.Stub(x => x.IncrementNumber());
            ...
            String _result = _sut.Print();
            _numberCounter.AssertWasCalled(x => x.IncrementNumber());
            Assert.AreEqual(_result, "pex tim");
        }
        [Test]
        public void It_Should_Return_Pex_Pex_When_Counter_Is_Dividable_With_Five()
        {
            _numberCounter.Stub(x => x.IncrementNumber());
            ...
            String _result = _sut.Print();
            _numberCounter.AssertWasCalled(x => x.IncrementNumber());
            Assert.AreEqual(_result, "pex pex");
        }
        [Test]
        public void It_Should_Return_Pex_Timpex_When_Counter_Is_Dividable_With_Five_and_Three()
        {
            _numberCounter.Stub(x => x.IncrementNumber());
            _numberCounter.Stub(x => x.GetValue()).Return(5);
            _counterPredicat.Stub(x => x.IsDividableWithFive(_numberCounter)).Return(true);
            ...
            String _result = _sut.Print();
            _numberCounter.AssertWasCalled(x => x.IncrementNumber());
            Assert.AreEqual(_result, "pex timpex");
        }
    }
}
