...
namespace Timpex.Reporting.Filesetup.All.Startpoints._Spec._StartpointEnglishStandard.New
{
    abstract class Start_Act : New_Act
    {
        ...
        protected override void Arrange()
        {
            ...
            CommandHandlerContainer.Stub(x => x.Resolve<StartpointReportsEngUtv>()).Return(StartpointReportsEng);
