...
namespace Timpex.Reporting.Filesetup.ByReporting.Reports.Utv.Eng._Spec
{
    abstract class New_Act : Base_Act
    {
        protected StartpointReportsEngUtv Sut;
        ...
        {
            Sut = new StartpointReportsEngUtv(FileTransferExecuter,FolderSettings,DirectoryImpl,AcceptedFileExtensionFactory,TransferInformationFactory,AcceptedFilePrefixFactory);
        }
    }
